            ...
            <div className='container'>
                ...
                <div className='span-3 img-details'>
                    <div className='top'>
                        ...
                        <p>House for Sale</p>
                        <p className='price'>RS12,677,000</p>
                    </div>
                    <div className='info-grid'>
                        ...
                        <div>
                            ...
                            <div className='info'>
                                <p className='bold'>Est Payment:</p><p>RS12,14,797/mo</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className='container'>
                ...
                <div className='span-3 img-details order-6'>
                    <div className='top'>
                        <h2>123 Acme St. Dallas, TX</h2>
                        <p>House for Sale</p>
                        <p className='price'>RS22,677,000</p>
                    </div>
                    <div className='info-grid'>
                        <div>
                            <div className='info'>
                        ...
                        <div>
                            ...
                            <div className='info'>
                                <p className='bold'>Est Payment:</p><p>RS32,14,797/mo</p>
                            </div>
                        </div>
                    </div>
                </div>
